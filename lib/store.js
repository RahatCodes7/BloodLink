...
export const seedDonors = [
  ...
  { id: 'd2', name: 'ফাতেমা খাতুন', blood_group: 'B+', division_id: 'dhaka', district_id: 'dhaka-d', available: true, donations: 2, phone: '01700000012' },
  { id: 'd3', name: 'সাকিব হাসান', blood_group: 'A-', division_id: 'chattogram', district_id: 'chattogram-d', available: false, donations: 6, phone: '01700000013' }
];

export function seedCampaigns() {
  const plus = (d) => { const t = new Date(); t.setDate(t.getDate() + d); return t.toISOString().slice(0, 10); };
  return [
    { id: 'c1', title: 'স্বেচ্ছায় রক্তদান কর্মসূচি', organizer_name: 'খুলনা ব্লাড ডোনার্স ক্লাব', description: 'সবার জন্য উন্মুক্ত স্বেচ্ছায় রক্তদান কর্মসূচি। সকাল ৯টা থেকে দুপুর ২টা।', division_id: 'khulna', district_id: 'khulna-d', upazila_id: 'khulna-sadar', venue: 'খুলনা প্রেসক্লাব মিলনায়তন', event_date: plus(6), start_time: 'সকাল ৯টা', end_time: 'দুপুর ২টা', contact_phone: '01700000021', status: 'UPCOMING', created_at: new Date().toISOString() },
    { id: 'c2', title: 'ক্যাম্পাস ব্লাড ড্রাইভ', organizer_name: 'ঢাকা কলেজ রোভার স্কাউট', description: 'শিক্ষার্থীদের জন্য রক্তদান কর্মসূচি ও সচেতনতা সভা।', division_id: 'dhaka', district_id: 'dhaka-d', upazila_id: 'mirpur', venue: 'ঢাকা কলেজ অডিটোরিয়াম', event_date: plus(13), start_time: 'সকাল ১০টা', end_time: 'বিকাল ৪টা', contact_phone: '01700000022', status: 'UPCOMING', created_at: new Date().toISOString() }
  ];
}
